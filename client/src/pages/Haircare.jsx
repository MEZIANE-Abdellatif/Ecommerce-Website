...
const Haircare = () => {
  ...
  const fetchHaircareProducts = useCallback(async () => {
    try {
      ...
      if (selectedHairType && selectedHairType !== 'all') {
        params.append('hairType', selectedHairType);
      }
  ...
  const hairTypes = [
    ...
    { id: 'oily_scalp', label: 'Oily Scalp', icon: '💧' },
    { id: 'dry_hair', label: 'Dry Hair', icon: '🌵' },
    ...
    { id: 'color_treated', label: 'Color Treated', icon: '🎨' }
  ];

  const productTypes = [
    { id: 'all', label: 'All Products', icon: '✨' },
    { id: 'shampoo', label: 'Shampoo', icon: '🧴' },
    { id: 'conditioner', label: 'Conditioner', icon: '💆‍♀️' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-rose-50 pt-0 relative overflow-hidden">
      {/* Animated Hair Flow Background with Mazzinka Colors */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Flowing Hair Elements */}
        <div className="absolute top-10 left-10 w-40 h-40 bg-gradient-to-br from-pink-300/20 to-purple-300/20 rounded-full animate-pulse opacity-60 transform rotate-12"></div>
        <div className="absolute top-20 right-20 w-32 h-32 bg-gradient-to-br from-purple-300/20 to-rose-300/20 rounded-full animate-pulse opacity-60 transform -rotate-12" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-20 left-1/3 w-24 h-24 bg-gradient-to-br from-rose-300/20 to-pink-300/20 rounded-full animate-pulse opacity-60 transform rotate-45" style={{ animationDelay: '2s' }}></div>
        
        {/* Hair Strands */}
        <div className="absolute top-1/4 left-1/4 w-1 h-20 bg-gradient-to-b from-pink-300/40 to-transparent animate-pulse opacity-60"></div>
        <div className="absolute top-1/3 right-1/4 w-1 h-16 bg-gradient-to-b from-purple-300/40 to-transparent animate-pulse opacity-60" style={{ animationDelay: '0.5s' }}></div>
        <div className="absolute bottom-1/3 left-1/4 w-1 h-24 bg-gradient-to-b from-rose-300/40 to-transparent animate-pulse opacity-60" style={{ animationDelay: '1.5s' }}></div>
      </div>

      {/* Hero Section with Hair-Inspired Design and Mazzinka Identity */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <nav className="text-sm text-gray-600 mb-8">
            <div className="inline-flex items-center space-x-3 bg-white/70 backdrop-blur-xl rounded-full px-8 py-4 shadow-2xl border border-white/30">
              ...
              <span className="text-gray-900 font-bold">Haircare</span>
            </div>
          </nav>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover our collection of premium haircare products
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 relative z-10">
        {/* Simple Haircare Filter System */}
        <div className="mb-16">
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/30">
            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-6 sm:mb-8 text-center">Find Your Perfect Hair Care</h3>
            
            {/* Hair Care Filters */}
            <div className="space-y-6">
              {/* Hair Type Selection */}
              <div className="space-y-4">
                <label className="text-lg font-semibold text-gray-700 block">Choose Your Hair Type</label>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {hairTypes.map((hairType) => (
                    <button
                      key={hairType.id}
                      onClick={() => setSelectedHairType(hairType.id)}
                    ...
                    >
                      <div className="text-sm font-medium">{hairType.label}</div>
                    </button>
                  ))}
                </div>
              </div>

              {/* Product Type & Sort Selection */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Product Type */}
                <div className="space-y-4">
                  <label className="text-lg font-semibold text-gray-700 block">Product Type</label>
                  <select 
              ...
              <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-white/30 hover:shadow-pink-500/25 transition-all duration-500 transform group-hover:-translate-y-2 group-hover:scale-102 h-full flex flex-col">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-auto">
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-pink-500 to-rose-500 rounded-2xl blur-lg group-hover/btn:scale-105 transition-all duration-500"></div>
